// HE REST Client
// ===============
// Client for RESTServer to demonstrate plain NIO HTTP has no slowdown.
...
@main
struct RESTClientCommand: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "RESTClient",
        abstract: "HE REST Client",
        discussion: """
            Client for testing RESTServer (plain NIO HTTP).
            Should show normal HE compute times (same as native).
            """)
    ...
    func runClient<Scheme: HeScheme>(_: Scheme.Type) async throws {
        ...
        print()
        print("=== Results (REST - NO SLOWDOWN) ===")
        ...
        print("this confirms the NIO executor slowdown affects HTTP too.")
    }
